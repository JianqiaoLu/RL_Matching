...
from environment import BinPackingActionMaskGymEnvironment, BipartiteMatchingActionMaskGymEnvironment
...
if __name__ == '__main__':
    ...
    # env = BipartiteMatchingActionMaskGymEnvironment()
    # env.read_graph_from_file("real_graph/lp_blend/lp_blend.mtx")
